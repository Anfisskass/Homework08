from view import (get_employee, get_changes, get_id, get_first_name, get_last_name, get_phone_number,
                  get_position, get_salary, get_salary_range, show_menu, show_search_menu, 
                  show_update_menu, no_employee_error, show_employee_info)
from model import (read_csv, read_json, write_csv, write_json, find_employee_by_id, 
                    ...
                    find_employee_by_salary_range, update_employee, del_employee,
                    find_employee, find_employee_by_position, add_employee)
...
def run_work():
    ...
    while True:
        ...
        if choice == 1:    #find employee
            ...
            emp_by_salary = find_employee_by_salary_range(employees)
